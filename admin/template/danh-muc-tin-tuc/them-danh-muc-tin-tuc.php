...
<form action="" method="post" accept-charset="utf-8" id="addNewsCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" value="<?= $row['newscat_name'];?>" name="newscat_name" required />
            <p class="titleRightNCP">Mô tả</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor1" name="newscat_des" ><?= $row['newscat_des'];?></textarea></p>
