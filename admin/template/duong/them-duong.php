<?php 
	...
	function duong () {
		...
		if (isset($_POST['add_duong'])) {
			...
			$sql = "INSERT INTO street (name, district_id) VALUES ('$name', $district_id)";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một Đường.\');window.location.href="/admin/index.php?page=duong"</script>';
			} else {
