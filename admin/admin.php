        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    /////////// goi dịch vụ //////////////
                    case "goi-dich-vu":
                        include_once("template/goi-dich-vu/goi-dich-vu.php");
                        break;
                    case "them-goi-dich-vu":
                        include_once("template/goi-dich-vu/them-goi-dich-vu.php");
                        break;
                    case "sua-goi-dich-vu":
                        include_once("template/goi-dich-vu/sua-goi-dich-vu.php");
                        break;
                    case "xoa-goi-dich-vu":
                        include_once("template/goi-dich-vu/xoa-goi-dich-vu.php");
                        break;
                    ////// các gói dịch vụ cập nhật ///////
                    case "sua-dtcb":
                        include_once("template/don-hang/sua-dtcb.php");
                        break;
                    case "sua-utnn":
                        include_once("template/don-hang/sua-utnn.php");
                        break;
                    case "sua-gtddd":
                        include_once("template/don-hang/sua-gtddd.php");
                        break;
                    case "sua-gtut":
                        include_once("template/don-hang/sua-gtut.php");
                        break;
                    case "sua-tdlmht":
                        include_once("template/don-hang/sua-tdlmht.php");
                        break;
                    case "sua-tdlmhn":
                        include_once("template/don-hang/sua-tdlmhn.php");
                        break;
                    case "sua-vlcql":
                        include_once("template/don-hang/sua-vlcql.php");
                        break;
                    case "sua-vltc":
                        include_once("template/don-hang/sua-vltc.php");
                        break;
                    case "sua-lmt":
                        include_once("template/don-hang/sua-lmt.php");
                        break;
                    case "sua-vlth":
                        include_once("template/don-hang/sua-vlth.php");
                        break;
                    case "sua-tkuv":
                        include_once("template/don-hang/sua-tkuv.php");
                        break;
                    case "sua-bntc":
                        include_once("template/don-hang/sua-bntc.php");
                        break;
                    ////////////// Quan Huyen ////////////
                    case "quan-huyen":
                    ...
                    ///////////// đường phố ///////////////
                    case "duong":
                        include_once("template/duong/duong.php");
                        break;
                    case "them-duong":
                        include_once("template/duong/them-duong.php");
                        break;
                    case "sua-duong":
                        include_once("template/duong/sua-duong.php");
                        break;
                    case "xoa-duong":
                        include_once("template/duong/xoa-duong.php");
                        break;
                    ////////////// muc luong //////////////
                    case "muc-luong":
                        include_once("template/muc-luong/muc-luong.php");
                        break;
                    case "them-muc-luong":
                        include_once("template/muc-luong/them-muc-luong.php");
                        break;
                    case "sua-muc-luong":
                        include_once("template/muc-luong/sua-muc-luong.php");
                        break;
                    case "xoa-muc-luong":
                        include_once("template/muc-luong/xoa-muc-luong.php");
                        break;
                    //////////// nhà tuyển dụng nổi bật////
                    case "noi-bat":
                        include_once("template/noi-bat/noi-bat.php");
                        break;
                    ////////////// banner /////////////////
                    case "banner":
                        ...
                        break;
                    case "them-banner":
                        include_once("template/banner/them-banner.php");
                        break;
                    case "sua-banner":
                        include_once("template/banner/sua-banner.php");
                        break;
                    case "xoa-banner":
                        include_once("template/banner/xoa-banner.php");
                        break;
                    ///////////// Default /////////////////
                    default:
