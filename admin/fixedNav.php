           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <li><a href="index.php?page=tin-tuc" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tin-tuc' || $_GET["page"] == 'them-tin-tuc' || $_GET["page"] == 'sua-tin-tuc') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Danh sách Công ty</a></li>
            ...
            <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Danh sách tư vấn</a></li>
            ...
            <li><a href="index.php?page=thanh-pho" title="" class="linkMenu <?php if ($_GET["page"] == 'thanh-pho') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tỉnh thành</a>
            </li>

            <li><a href="index.php?page=quan-huyen" title="" class="linkMenu <?php if ($_GET["page"] == 'quan-huyen') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Quận huyện</a>
            </li>

            <li><a href="index.php?page=duong" title="" class="linkMenu <?php if ($_GET["page"] == 'duong') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đường</a>
            </li>

            <li><a href="index.php?page=nganh-nghe" title="" class="linkMenu <?php if ($_GET["page"] == 'nganh-nghe') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ngành nghề</a>
            </li>

            <li><a href="index.php?page=goi-dich-vu" title="" class="linkMenu <?= $_GET['page']=='goi-dich-vu' ? 'sltMenu' : '' ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Gói dịch vụ</a>
            </li>

            <li><a href="index.php?page=noi-bat" title="" class="linkMenu <?= $_GET['page']=='noi-bat' ? 'sltMenu' : '' ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhà tuyển dụng nổi bật</a>
            </li>

            <li><a href="index.php?page=banner" title="" class="linkMenu <?= $_GET['page']=='banner' ? 'sltMenu' : '' ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Banner Home</a>
            </li>

            <li><a href="index.php?page=muc-luong" title="" class="linkMenu <?= $_GET['page']=='muc-luong' ? 'sltMenu' : '' ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mức lương</a>
            </li>
