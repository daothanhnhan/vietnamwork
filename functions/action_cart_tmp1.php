           ...
           {  
                $order_table .= '  
                     <tr>  
                          ...
                          <td><input type="text" name="quantity[]" id="quantity'.$values["product_id"].'" value="'.$values["product_quantity"].'" class="form-control quantity" data-product_size="'.$values['product_size'].'" data-product_id="'.$values["product_id"].'" /></td>  
                          ...
                          <td><button name="delete" class="btn btn-danger btn-xs delete" size="'.$values['product_size'].'" id="'.$values["product_id"].'">Remove</button></td>  
                     </tr>  
                ';  
